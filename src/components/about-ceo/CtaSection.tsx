  ...
  return (
    <section className="text-center mb-20">
      <motion.div
        ...
        className="bg-gold-500 text-white py-12 px-6 rounded-2xl"
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          href={`tel:${phone}`}
          className="inline-flex items-center justify-center px-8 py-3 bg-white text-gold-600 font-medium rounded-full hover:bg-gold-50 transition-colors"
        >
          Contact Now: {phone}
        </motion.a>
      </motion.div>
