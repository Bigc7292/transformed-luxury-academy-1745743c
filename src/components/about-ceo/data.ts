...
import { AwardType, CourseType } from './types';
...
export const trainingCourses: CourseType[] = [
  {
    id: 1,
...
export const personalStatement = "My passion is to empower the next generation of aesthetics practitioners with the skills, knowledge, and confidence they need to excel in this ever-evolving industry. I believe in hands-on, personalized training that prepares you for real-world success.";

export const ceoDetails = {
  name: "Kayla",
  title: "Founder & CEO of Transformed Academy",
  description: "With extensive experience and recognition in the beauty and aesthetics industry, Kayla has established herself as a leading figure and educator in the field. Her passion for excellence and innovation has led to multiple awards and accolades.",
  image: "/lovable-uploads/decb2b79-3774-449a-b7b7-479a89096676.png"
};
