...
const Benefits = () => {
  ...
  return <section className="py-20 bg-gold-50">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-12 lg:mb-0">
            ...
            once: true
              ...
              <div className="absolute -top-6 -left-6 w-24 h-24 bg-gold-200 rounded-full opacity-50"></div>
              ...
              <div className="absolute top-1/2 right-0 transform translate-x-1/4 -translate-y-1/2 bg-white p-4 rounded-lg shadow-lg max-w-[200px]">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gold-700">100% Satisfaction</p>
          ...
          <div className="lg:w-1/2 lg:pl-12">
            ...
            once: true
              ...
              <span className="text-gold-400 font-medium">Why Choose Us</span>
              <h2 className="text-3xl md:text-4xl font-serif text-gold-800 mt-2">Benefits of Transformed Academy</h2>
            ...
            <div className="space-y-6">
              ...
              once: true
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-gold-700">{benefit.title}</h3>
