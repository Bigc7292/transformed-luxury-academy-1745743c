    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 pt-28 md:pt-32 max-w-4xl">
        ...
        <div className="prose prose-zinc prose-sm md:prose-lg max-w-none overflow-x-hidden">
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">2. Services</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">3. Appointments and Cancellations</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">4. Payment Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">5. Training Courses</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">6. Health and Safety</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">7. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">8. User Content</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">9. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">10. Indemnification</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">11. Governing Law</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">12. Changes to Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif text-gold-600 mt-8 mb-4">13. Contact Information</h2>
          <p>
