    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-16 px-4 md:px-0">
            <motion.div
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 md:space-y-4">
                <div>
                  <label htmlFor="name" className="block text-base md:text-sm font-medium text-gray-700 mb-2 md:mb-1">
                ...
                <div>
                  <label htmlFor="email" className="block text-base md:text-sm font-medium text-gray-700 mb-2 md:mb-1">
