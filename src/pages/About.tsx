      ...
      <div className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <motion.div
            ...
            className="bg-salon-pink-50 rounded-lg p-8 mb-16"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            >
              <div className="w-16 h-16 bg-salon-pink-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-salon-pink-600 text-2xl">✨</span>
              </div>
